                  ...
                  <table id="mainRules" class="responsive table cr_main_table">
                     ...
                     <tbody>
                        ...
                        <tr>
                           ...
                           <td class="cr_sz">
                              <select id="date" name="newsomatic_all_list[date][]" class="cr_width_full">
                                                ...
                                                <td>
                                                   <div>
                                                      <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                                                         <div class="bws_hidden_help_text cr_min_260px">
                                                            <?php
                                                               echo esc_html__("Do you want to filter results based on a query string? Advanced search is supported here: Prepending a term with a hyphen will exclude posts matching that term. Eg, 'pillow -sofa'", 'newsomatic-news-post-generator');
                                                               ?>
                                                         </div>
                                                      </div>
                                                ...
                                                <td>
                                                   <div>
                                                      <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                                                         <div class="bws_hidden_help_text cr_min_260px">
                                                            <?php
                                                               echo esc_html__("Do you want to filter results based on a query string in article title only? Please note that only keywords are supported here (no phrase search).", 'newsomatic-news-post-generator');
                                                               ?>
                                                         </div>
                                                      </div>
                                                ...
                                                <td class="cr_min_width_200">
                                                   <div>
                                                      <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                                                         <div class="bws_hidden_help_text cr_min_260px">
                                                            <?php
                                                               echo esc_html__("Set the title of the generated posts for user rules. You can use the following shortcodes: %%random_sentence%%, %%random_sentence2%%, %%item_title%%, %%author%%, %%item_description%%, %%item_content%%, %%item_date%%, %%item_original_content%%, %%item_cat%%, %%item_tags%%, %%item_source%%, %%item_source_id%%", 'newsomatic-news-post-generator');
                                                               ?>
                                                         </div>
                                                      </div>
                              ...
                              <?php
                                 ...
                                 ?>
                                             ...
                                             <tr>
                                                ...
                                                <td>
                                                <select multiple id="default_category" name="newsomatic_all_list[default_category][]" class="cr_width_full">
                                             ...
                                             <tr>
                                                <td>
                                                   <div class="hideFull">
                                                      ...
                                                      <b><?php echo esc_html__("Search Query String (Optional)", 'newsomatic-news-post-generator');?> <a name="help" href="admin.php?page=newsomatic_helper" target="_blank"><?php echo esc_html__("Help!", 'newsomatic-news-post-generator');?></a>:</b>
                                                   </div>
                                                </td>
                                                <td>
                                                   <div class="hideFull">
                                             ...
                                             <td>
                                                <div class="hideFull">
                                                   <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                                                      <div class="bws_hidden_help_text cr_min_260px">
                                                         <?php
                                                            echo sprintf( wp_kses( __( "Input the correct HTML attribute where the image src is found for lazy loaded images that are scraped from the full content. The attribute containing the actual image URL ex: \"data-src\" or \"data-original\"", 'newsomatic-news-post-generator'), array(  'a' => array( 'href' => array(), 'target' => array() ) ) ), esc_url( 'https://regexone.com/' ), esc_url( 'https://www.w3schools.com/xml/xpath_intro.asp' ) );
                                                            ?>
                                                      </div>
                                                   </div>
    ...
    if(!is_array($rules))
    {
       ...
       if (!empty($rules)) {
           ...
           foreach ($rules as $request => $bundle[]) {
               ...
               $output .= '</td>
                           <td class="cr_sz"><select id="date' . esc_html($cont) . '" name="newsomatic_all_list[date][]" class="cr_width_full">';
       ...
       foreach ( get_post_types( '', 'names' ) as $post_type ) {
          ...
          $output .= '>' . esc_html($post_type) . '</option>';
           ...
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
               ...
               $output .= '>' . esc_html__("Import author", 'newsomatic-news-post-generator') . '</option>';
               $output .= '</select>
           </div>
           </td></tr><tr><td>
           <div>
           ...
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                       ...
                       <select multiple class="cr_width_full" id="default_category" name="newsomatic_all_list[default_category' . esc_html($cont) . '][]">
           ...
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                       ...
                       <b>' . esc_html__("Search Query String (Optional)", 'newsomatic-news-post-generator') . ' <a name="help" href="admin.php?page=newsomatic_helper" target="_blank">' . esc_html__("Help!", 'newsomatic-news-post-generator') . '</a>:</b>
                       </div>
                       </td><td>
                       <div class="hideFull' . esc_html($cont) . '">
           ...
           <div class="hideFull' . esc_html($cont) . '">
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                                           <div class="bws_hidden_help_text cr_min_260px">' . sprintf( wp_kses( __( 'Input the correct HTML attribute where the image src is found for lazy loaded images that are scraped from the full content. The attribute containing the actual image URL ex: \"data-src\" or \"data-original\"', 'newsomatic-news-post-generator'), array(  'a' => array( 'href' => array(), 'target' => array() ) ) ), esc_url( 'https://regexone.com/' ), esc_url( 'https://www.w3schools.com/xml/xpath_intro.asp' ) ) . '
                           </div>
                       </div>
       ...
       <div class="codemodalfzr-footer">
         ...
         <br/><br/>
               ...
               $output .= '/>
                           ...
                           <div class="bws_hidden_help_text cr_min_260px">' . sprintf( wp_kses( __( 'Shortcode for this rule<br/>(to cross-post from this plugin in other plugins):', 'newsomatic-news-post-generator'), array(  'br' => array( ) ) ) ) . '<br/><b>%%newsomatic_1_' . esc_html($cont) . '%%</b><br/>' . esc_html__('Posts Generated:', 'newsomatic-news-post-generator') . ' ' . esc_html($generated_posts) . '<br/>';
