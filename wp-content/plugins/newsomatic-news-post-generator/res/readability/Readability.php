...
use newsomatic_andreskrey\Readability\Nodes\DOM\DOMDocument;
use newsomatic_andreskrey\Readability\Nodes\DOM\DOMElement;
use newsomatic_andreskrey\Readability\Nodes\DOM\DOMNode;
use newsomatic_andreskrey\Readability\Nodes\DOM\DOMText;
use newsomatic_andreskrey\Readability\Nodes\NodeUtility;
use Psr\Log\LoggerInterface;

/**
 * Class ReadabilityNewsomatic.
 */
if(!class_exists('ReadabilityNewsomatic'))
{
class ReadabilityNewsomatic
{
    /**
