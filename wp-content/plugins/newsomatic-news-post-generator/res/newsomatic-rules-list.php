                  ...
                  <table id="mainRules" class="responsive table cr_main_table">
                     ...
                     <tbody>
                        ...
                        <tr>
                           ...
                           <td class="cr_sz">
                              <select id="date" name="newsomatic_rules_list[date][]" class="cr_width_full">
                                                ...
                                                <td class="cr_min_width_200">
                                                   <div>
                                                      <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                                                         <div class="bws_hidden_help_text cr_min_260px">
                                                            <?php
                                                               echo esc_html__("Set the title of the generated posts for user rules. You can use the following shortcodes: %%random_sentence%%, %%random_sentence2%%, %%item_date%%, %%item_media%%, %%author%%, %%item_title%%, %%item_description%%, %%item_content%%, %%item_original_content%%, %%item_cat%%, %%item_tags%%, %%item_source%%, %%item_source_id%%", 'newsomatic-news-post-generator');
                                                               ?>
                                                         </div>
                                                      </div>
...
<?php
    ...
    if(!is_array($rules))
    {
       ...
       if (!empty($rules)) {
           ...
           foreach ($rules as $request => $bundle[]) {
               ...
               $output .= '</td>
                           <td class="cr_sz"><select id="date' . esc_html($cont) . '" name="newsomatic_rules_list[date][]" class="cr_width_full">';
   ...
   $output .= '</select></td>
     ...
     <div class="codemodalfzr-content">
       ...
       <div>
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                                           <div class="bws_hidden_help_text cr_min_260px">' . esc_html__("Set the title of the generated posts for user rules. You can use the following shortcodes:  %random_sentence%%, %%random_sentence2%%, %%item_title%%, %%author%%, %%item_description%%, %%item_content%%, %%item_original_content%%, %%item_cat%%, %%item_tags%%, %%item_source%%, %%item_source_id%%", 'newsomatic-news-post-generator') . '
                           </div>
                       </div>
