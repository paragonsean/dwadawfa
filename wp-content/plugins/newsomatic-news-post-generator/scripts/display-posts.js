...
registerBlockType( 'newsomatic-news-post-generator/newsomatic-display', {
    title: 'Newsomatic Display Posts',
    icon: 'testimonial',
    category: 'embed',
    attributes: {
        ruletype : {
    ...
    keywords: ['display', 'posts', 'newsomatic'],
    edit: (function( props ) {
