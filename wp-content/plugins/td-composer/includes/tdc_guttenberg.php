    ...
    public function __construct() {
	    ...
	    add_action( 'admin_enqueue_scripts', function() {
		    ...
		    if ( $this->is_gutenberg_editor_active && $this->show_on_this_post_type ) {
			    ...
			    if ( TDC_DEPLOY_MODE == 'deploy' ) {
				    wp_enqueue_script( 'js_files_for_gutenberg_yoast_analyzer', TDC_URL . '/assets/js/js_files_for_gutenberg_yoast_analyzer.min.js', array('jquery'), TD_COMPOSER, true );
			    } else {
				    wp_enqueue_script( 'tdcYoastAnalyzer', TDC_URL . '/assets/js/tdcYoastAnalyzer.js', array('jquery'), TD_COMPOSER, true );
			    }
