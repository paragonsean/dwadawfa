...
v=b.find(".tdc-css-border-radius").val().trim(),y=b.find(".tdc-css-width").val().trim(),B=b.find(".tdc-css-height").val().trim(),z=b.find(".tdc-css-shadow-size").val().trim(),t=b.find(".tdc-css-shadow-offset-h").val().trim(),u=b.find(".tdc-css-shadow-offset-v").val().trim(),A=b.find(".tdc-css-opacity").val().trim(),C=b.find(".tdc-css-gradient-direction").val().trim(),D=b.find(".tdc-css-z-index").val().trim(),E="";b.find(".tdc-css-order").length&&(E=b.find(".tdc-css-order").val().trim());""!==d&&(c["margin-top"]=
...
f);d=b.find(".tdc-css-border-color");f=d.val().trim();""!==f?c["border-color"]=f:(d=d.data("no_value"),a.isUndefined(d)||1!==d||(c["border-color"]="no_value"));""!==v&&(c["border-radius"]=v);""!==y&&(c.width=y);""!==B&&(c.height=B);""!==z&&(c["shadow-size"]=z);v=b.find(".tdc-css-shadow-color");y=v.val().trim();""!==y?c["shadow-color"]=y:(v=v.data("no_value"),a.isUndefined(v)||1!==v||(c["shadow-color"]="no_value"));""!==t&&(c["shadow-offset-h"]=t);""!==u&&(c["shadow-offset-v"]=u);t=b.find(".tdc-css-bg-color");
u=t.val().trim();""!==u?c["background-color"]=u:(t=t.data("no_value"),a.isUndefined(t)||1!==t||(c["background-color"]="no_value"));t=b.find(".tdc-css-bg-image");t.closest(".tdc-property-wrap").hasClass(tdcCssEditor._INHERITED_CSS_CLASS)||(t=t.data("image_link"),a.isUndefined(t)||("no_value"===t?c["background-image"]="no_value":""!==t&&(c["background-image"]='url("'+t+'")')));t=b.find(".tdc-css-bg-style");u=t.val().trim();""===u||t.closest(".tdc-property-wrap").hasClass(tdcCssEditor._INHERITED_CSS_CLASS)||
(c["background-style"]=u);t=b.find(".tdc-css-bg-position");u=t.val().trim();""===u||t.closest(".tdc-property-wrap").hasClass(tdcCssEditor._INHERITED_CSS_CLASS)||(c["background-position"]=u);""!==A&&(c.opacity=A);A=b.find(".tdc-css-color-1-overlay");t=A.val().trim();""!==t?c["color-1-overlay"]=t:(A=A.data("no_value"),a.isUndefined(A)||1!==A||(c["color-1-overlay"]="no_value"));A=b.find(".tdc-css-color-2-overlay");t=A.val().trim();""!==t?c["color-2-overlay"]=t:(A=A.data("no_value"),a.isUndefined(A)||
1!==A||(c["color-2-overlay"]="no_value"));""!==C&&(c["gradient-direction"]=C);""!==E&&(c.order=E);""!==D&&(c["z-index"]=D);C=b.find(".tdc-css-content-h-align");D=C.val().trim();""===D||C.closest(".tdc-property-wrap").hasClass(tdcCssEditor._INHERITED_CSS_CLASS)||(c["content-h-align"]=D);b=b.find(".tdc-css-display");c.display=b.val().trim();a.isUndefined(tdcCssEditor._currentCssSettings)&&(tdcCssEditor._currentCssSettings={});a.isUndefined(c["border-style"])||"solid"!==c["border-style"]||("all"===tdcSidebar.currentViewportSettings.name||
...
function(a){var b=jQuery(this),c=b.closest(".tdc-property-responsive"),d=c.find('input[type="range"]'),f=c.find('input[type="radio"]:checked'),g=c.find('input[type="text"]'),l=d.get(0),n="",h=f.data("default_value"),m=tdcIFrameData.getModel(d.data("model_id")),q=d.data("param_name"),p=window.tdcAdminSettings.mappedShortcodes[m.attributes.tag],k=m="";var r=[];for(var w=0;w<p.params.length;w++)if(q===p.params[w].param_name){w=p.params[w].tdc_values;for(var v in w)w.hasOwnProperty(v)&&(r.push(w[v].unit),
""===m||""===k)&&(m=w[v].value,k=w[v].unit);break}f.length&&(n=f.data("unit_value"));if("range"===b.attr("type"))r=d.val(),g.val(r),f.data("last_value",r),g.val(r),d.data("data-to-save",tdcSidebarPanel.updateTextfieldResponsiveValues(d.attr("name"),r+n,tdcSidebar.currentViewportSettings.name)),c.removeClass("tdc-css-inherited");else if("text"===b.attr("type")){if("input"===a.type||"change"===a.type)return;c.removeClass("tdc-css-inherited");r=g.val().trim();if("all"===tdcSidebar.currentViewportSettings.name)""!==
r||_.isUndefined(h)||""===h?(d.val(r),f.data("last_value",r),d.data("data-to-save",tdcSidebarPanel.updateTextfieldResponsiveValues(d.attr("name"),r+n,tdcSidebar.currentViewportSettings.name))):(d.data("data-to-save",tdcSidebarPanel.deleteResponsiveValue("tdc-param-"+q,tdcSidebar.currentViewportSettings.name)),d.data("range_value",m),d.data("range_unit",k),d.val(m),n=c.find('input[type="radio"][data-unit_value="'+k+'"]'),p=n.data("unit"),v=d.data("min_"+p),f=d.data("max_"+p),p=d.data("step_"+p),n.prop("checked",
!0),l.min=v,l.max=f,l.step=p,l.value=m,n.data("last_value",m),g.val(m));else if(""===r)if(n=tdcSidebarPanel.getCurrentResponsiveValue(d.attr("name"),"all"),"undefined"===typeof n)d.data("data-to-save",tdcSidebarPanel.deleteResponsiveValue("tdc-param-"+q,tdcSidebar.currentViewportSettings.name)),d.data("range_value",m),d.data("range_unit",k),d.val(m),n=c.find('input[type="radio"][data-unit_value="'+k+'"]'),p=n.data("unit"),v=d.data("min_"+p),f=d.data("max_"+p),p=d.data("step_"+p),n.prop("checked",
!0),l.min=v,l.max=f,l.step=p,l.value=m,n.data("last_value",m),g.val(m),c.addClass("tdc-css-inherited");else for(w=0;w<p.params.length;w++){if(q===p.params[w].param_name){r=[];g=[];w=p.params[w].tdc_values;for(v in w)w.hasOwnProperty(v)&&r.push(w[v].unit);for(w=0;w<r.length&&!(g=n.split(r[w]),1<g.length);w++);g.length&&(m=g[0],k=r[w],d.data("range_value",m),d.data("range_unit",k),n=c.find('input[type="radio"][data-unit_value="'+k+'"]'),p=n.data("unit"),v=d.data("min_"+p),f=d.data("max_"+p),p=d.data("step_"+
p),n.prop("checked",!0),l.min=v,l.max=f,l.step=p,l.value=m,n.data("last_value",m),c.find('input[type="text"]').val(m));d.data("data-to-save",tdcSidebarPanel.deleteResponsiveValue("tdc-param-"+q,tdcSidebar.currentViewportSettings.name));c.addClass("tdc-css-inherited");break}}else d.val(r),f.data("last_value",r),d.data("data-to-save",tdcSidebarPanel.updateTextfieldResponsiveValues(d.attr("name"),r+n,tdcSidebar.currentViewportSettings.name))}else if("radio"===b.attr("type")){if("input"===a.type)return;
q=f.data("last_value");p=f.data("unit");v=d.data("min_"+p);f=d.data("max_"+p);p=d.data("step_"+p);l.min=v;l.max=f;l.step=p;""===q?(g.val(h),d.val(h),r=h):(g.val(q),d.val(q),r=q);d.data("data-to-save",tdcSidebarPanel.updateTextfieldResponsiveValues(d.attr("name"),r+n,tdcSidebar.currentViewportSettings.name));c.removeClass("tdc-css-inherited")}n="";c=jQuery(l).parent().find('input[type="radio"]:checked');c.length&&(n=jQuery(c[0]).data("unit_value"));"focusin"===a.type?l.oldValue=l.value+n:(c=jQuery(l),
...
var h=n=l="";for(e=0;e<b.length;e++){f=tdcSidebarPanel._fixGroupName(b[e]);var m=tdcUtil.makeSafeForCSS(f);0===e?(l='<a href="#" data-tab-id="td-tab-'+m+'" class="tdc-tab-active" title="'+f+' settings">'+f+'<span class="tdc-tab-search-notice"></span></a>',n='<a href="#" data-tab-id="td-tab-'+m+'" title="'+f+' settings">'+f+'<span class="tdc-tab-search-notice"></span></a>'):_.isUndefined(g)||g!=="td-tab-"+m?h+='<a href="#" data-tab-id="td-tab-'+m+'" title="'+f+' settings">'+f+'<span class="tdc-tab-search-notice"></span></a>':
(l=n,h+='<a href="#" data-tab-id="td-tab-'+m+'" class="tdc-tab-active" title="'+f+' settings">'+f+'<span class="tdc-tab-search-notice"></span></a>')}d=d+(l+h)+"</div>";h=n=l=e="";if(tdcState.isMobileComposer())switch(tdcSidebar.currentViewportSettings.name){case "all":e="selected";break;case "phone":h="selected"}else switch(tdcSidebar.currentViewportSettings.name){case "all":e="selected";break;case "landscape":l="selected";break;case "portrait":n="selected";break;case "phone":h="selected"}d+='<div class="tdc-tab-responsive"><div class="tdc-responsive-buttons">';
...
c.length&&c.each(function(a,b){tdcSidebarPanel.toggleEnableTDSMenuLoginDrodownOnlyParams(jQuery(b))});c=jQuery('.tdc-fs-link-post-toggle input[type="checkbox"]');c.length&&c.each(function(a,b){tdcSidebarPanel.toggleEnableFSLinkPostParams(jQuery(b))})}},_bindGroupAndGetHtml:function(a,c,b){var e="",d=b.get("attrs");if("tdc_zone"===b.get("tag"))var f=d.type;for(var g=0;g<c.params.length;g++){var l=c.params[g].param_name,n=c.params[g].group;if(a===tdcSidebarPanel._defaultGroupName&&_.isEmpty(c.params[g].group)||
...
a.toggle_enable_params_reverse&&(n='data-enable-params-reverse="1"');var h="";_.has(a,"toggle_enabled_by")&&""!==a.toggle_enabled_by&&(h='data-enabled-by="'+a.toggle_enabled_by+'"');var m="";_.has(a,"toggle_disabled_by")&&""!==a.toggle_disabled_by&&(m='data-disabled-by="'+a.toggle_disabled_by+'"');var k="",p="",x=Object.keys(a.value);if(_.has(a,"tdc_min_options")&&x.length<=parseInt(a.tdc_min_options))return k;for(var r=0;r<x.length;r++){var w=!1,v="",y="",B="",z=x[r],t=String(tdcSidebarPanel._getParameterCurrentValue(a,
c)),u=String(a.value[x[r]]);_.has(a,"options_to_disable")&&""!==a.options_to_disable&&(y=a.options_to_disable);_.isObject(a.value[x[r]])&&(w=!0,u=_.values(a.value[x[r]])[0],z=_.keys(a.value[x[r]])[0]);if(d||f)0===r&&""===t&&(t=u),t===u&&(v=" checked "),y=_.uniqueId(),B=u,"vc_row"!==c.attributes.tag&&"vc_row_inner"!==c.attributes.tag||-1!==a.param_name.indexOf("flex_")||(B="col_"+B),p+='<input class="tdc-property-input-radio" type="radio" '+tdcSidebarPanel._getParamterDataAtts(a,c)+' id="'+y+'" name="'+
tdcSidebarPanel._getParameterDomName(a)+'" '+v+' value="'+u+'">',d?(v="",w&&(v="tdc-standard-value"),p+='<label class="tdc-property-input-radio-label '+v+'" for="'+y+'" title="'+z+'"><div class="'+B+'"></div></label>'):p+='<label class="tdc-property-input-radio-label" for="'+y+'" title="'+z+'">'+u+"</label>";else{t===u&&(v=' selected="selected" ');if("__"===u&&-1!==z.search("--")||-1<y.indexOf(u)&&""!==u)B=" disabled ";p+="<option "+v+" "+B+' value="'+u+'">'+z+"</option>"}}x="";_.has(a,"description")&&
""!==a.description&&(""!==b?e='data-info-descr="'+a.description+'"':x=' title="'+a.description+'" ');k+='<div class="'+tdcSidebarPanel._getParameterClasses(a)+'" '+b+" "+e+" "+g+" "+l+" "+n+" "+h+" "+m+">";k+='<div class="tdc-property-title"><span class="tdc-search-data"'+x+">"+a.heading+"</span>";b="";e="#";"tdb_flex_block_builder"===c.get("tag")&&"cloud_tpl_module_id"===a.param_name&&(b="tdc-edit-cloud_tpl_module_id",g='style="margin-left: 10px"',_.has(c.get("attrs"),"cloud_tpl_module_id")?""===
...
'"');var l="";_.has(a,"toggle_enable_params_reverse")&&!0===a.toggle_enable_params_reverse&&(l='data-enable-params-reverse="1"');var n="";_.has(a,"toggle_enabled_by")&&""!==a.toggle_enabled_by&&(n='data-enabled-by="'+a.toggle_enabled_by+'"');var h="",m="",k=Object.keys(a.value);if(_.has(a,"tdc_min_options")&&k.length<=parseInt(a.tdc_min_options))return h;var p=' data-responsive="" ',x=String(tdcSidebarPanel._getParameterCurrentValue(a,c));try{var r=JSON.parse(window.atob(x));p=' data-responsive="'+
x+'" ';"undefined"!==typeof r[tdcSidebar.currentViewportSettings.name]&&(x=r[tdcSidebar.currentViewportSettings.name])}catch(u){}for(r=0;r<k.length;r++){var w=!1,v="",y="",B=k[r],z=String(a.value[k[r]]);_.isObject(a.value[k[r]])&&(w=!0,z=_.values(a.value[k[r]])[0],B=_.keys(a.value[k[r]])[0]);if(d||f){0===r&&""===x&&(x=z);x===z&&(v=" checked ");y=_.uniqueId();var t=z;"vc_row"!==c.attributes.tag&&"vc_row_inner"!==c.attributes.tag||-1!==a.param_name.indexOf("flex_")||(t="col_"+t);m+='<input class="tdc-property-input-radio" type="radio" '+
tdcSidebarPanel._getParamterDataAtts(a,c)+' id="'+y+'" name="'+tdcSidebarPanel._getParameterDomName(a)+'" '+v+' value="'+z+'" '+p+">";d?(v="",w&&(v="tdc-standard-value"),m+='<label class="tdc-property-input-radio-label '+v+'" for="'+y+'" title="'+B+'"><div class="'+t+'"></div></label>'):m+='<label class="tdc-property-input-radio-label" for="'+y+'" title="'+B+'">'+z+"</label>"}else x===z&&(v=' selected="selected" '),"__"===z.substring(0,2)&&-1!==B.search("--")&&(y=" disabled "),m+="<option "+v+" "+
y+' value="'+z+'">'+B+"</option>"}k="";_.has(a,"description")&&""!==a.description&&(""!==b?e='data-info-descr="'+a.description+'"':k=' title="'+a.description+'" ');h+='<div class="tdc-property-responsive '+tdcSidebarPanel._getParameterClasses(a)+'" '+b+" "+e+" "+g+" "+l+" "+n+">";h+='<div class="tdc-property-title"><span class="tdc-search-data"'+k+">"+a.heading+'<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-select" style="display: block;"></div></span></div>';h+='<div class="tdc-property">';
d||f?h+=m:(h+="<select "+tdcSidebarPanel._getParamterDataAtts(a,c)+' name="'+tdcSidebarPanel._getParameterDomName(a)+'" '+p+k+">",h=h+m+"</select>");h=h+'</div><span class="tdc-param-name">'+(a.param_name+"</span>");return h+"</div>"},addCheckBox:function(a,c){var b="",e="";_.has(a,"info_img")&&""!==a.info_img&&(b='data-info-img="'+a.info_img+'"');var d="";_.has(a,"description")&&""!==a.description&&(""!==b?e='data-info-descr="'+a.description+'"':d=' title="'+a.description+'" ');var f="",g=tdcSidebarPanel._getParameterCurrentValue(a,
...
""!==a.toggle_disabled_by&&(m='data-disabled-by="'+a.toggle_disabled_by+'"');g="";var k=tdcSidebarPanel._getParameterClasses(a);k.includes("tdc-filter-multiple")&&(g=' title="'+a.description+'" ');b='<div class="'+k+'" '+b+" "+e+" "+l+" "+n+" "+h+" "+m+'><div class="tdc-property-title"><span class="tdc-search-data"'+(d+">"+a.heading+"</span></div>");b=b+'<div class="tdc-property"><input '+(tdcSidebarPanel._getParamterDataAtts(a,c)+' name="'+tdcSidebarPanel._getParameterDomName(a)+'" type="checkbox" value="yes" '+
f+" "+g+"/>");b=b+'</div><span class="tdc-param-name">'+(a.param_name+"</span>");return b+"</div>"},addCheckBoxResponsive:function(a,c){var b="",e="";_.has(a,"info_img")&&""!==a.info_img&&(b='data-info-img="'+a.info_img+'"');var d="",f=' data-responsive="" ',g=String(tdcSidebarPanel._getParameterCurrentValue(a,c));try{var l=JSON.parse(window.atob(g));f=' data-responsive="'+g+'" ';"undefined"!==typeof l[tdcSidebar.currentViewportSettings.name]&&(g=l[tdcSidebar.currentViewportSettings.name])}catch(m){}""!==
g&&(d=" checked ");l="";_.has(a,"description")&&""!==a.description&&(""!==b?e='data-info-descr="'+a.description+'"':l=' title="'+a.description+'" ');g="";_.has(a,"toggle_enable_params")&&""!==a.toggle_enable_params&&(g='data-enable-params="'+a.toggle_enable_params+'"');var n="";_.has(a,"toggle_enable_params_reverse")&&!0===a.toggle_enable_params_reverse&&(n='data-enable-params-reverse="1"');var h="";_.has(a,"toggle_enabled_by")&&""!==a.toggle_enabled_by&&(h='data-enabled-by="'+a.toggle_enabled_by+
'"');b='<div class="tdc-property-responsive '+tdcSidebarPanel._getParameterClasses(a)+'" '+b+" "+e+" "+g+" "+n+" "+h+">";b+='<div class="tdc-property-title"><span class="tdc-search-data"'+l+">"+a.heading+'<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-checkbox" style="display: block;"></div></span></div>';b=b+'<div class="tdc-property"><input '+(tdcSidebarPanel._getParamterDataAtts(a,c)+' name="'+tdcSidebarPanel._getParameterDomName(a)+'" type="checkbox" value="yes" '+d+f+
...
a.range_step&&(l=a.range_step);var n="";_.has(a,"value")&&""!==a.value&&(n=a.value);var h="";""!==tdcSidebarPanel._getParameterCurrentValue(a,c)&&(h=tdcSidebarPanel._getParameterCurrentValue(a,c));var m="";_.has(a,"toggle_enable_params")&&""!==a.toggle_enable_params&&(m='data-enable-params="'+a.toggle_enable_params+'"');var k="";_.has(a,"toggle_enable_params_reverse")&&!0===a.toggle_enable_params_reverse&&(k='data-enable-params-reverse="1"');var p="";_.has(a,"toggle_enabled_by")&&""!==a.toggle_enabled_by&&
(p='data-enabled-by="'+a.toggle_enabled_by+'"');b='<div class="'+tdcSidebarPanel._getParameterClasses(a)+'" '+b+" "+e+" "+m+" "+k+" "+p+">";b+='<div class="tdc-property-title"><span class="tdc-search-data"'+d+">"+a.heading+"</span></div>";b=b+'<div class="tdc-property"><input '+(tdcSidebarPanel._getParamterDataAtts(a,c)+' name="'+tdcSidebarPanel._getParameterDomName(a)+'" type="range" data-value="'+h+'" data-min="'+g+'" data-max="'+f+'" data-step="'+l+'" min="'+g+'" max="'+f+'" step="'+l+'" value="'+
h+'" />');b=b+('<input type="text" class="tdc_range_value" data-default_value="'+n+'" value="'+h+'"/></div><span class="tdc-param-name">')+(a.param_name+"</span>");return b+="</div>"},addRangeResponsive:function(a,c){var b="",e="";_.has(a,"info_img")&&""!==a.info_img&&(b='data-info-img="'+a.info_img+'"');var d="";_.has(a,"description")&&""!==a.description&&(""!==b?e='data-info-descr="'+a.description+'"':d=' title="'+a.description+'" ');var f="";_.has(a,"range_max")&&""!==a.range_max&&(f=a.range_max);
var g="";_.has(a,"range_min")&&""!==a.range_min&&(g=a.range_min);var l="";_.has(a,"range_step")&&""!==a.range_step&&(l=a.range_step);var n="";_.has(a,"value")&&""!==a.value&&(n=a.value);""!==tdcSidebarPanel._getParameterCurrentValue(a,c)&&tdcSidebarPanel._getParameterCurrentValue(a,c);var h="";_.has(a,"placeholder")&&""!==a.placeholder&&(h=' data-placeholder="'+a.placeholder+'" placeholder="'+a.placeholder+'" ');var m="";_.has(a,"toggle_enable_params")&&""!==a.toggle_enable_params&&(m='data-enable-params="'+
a.toggle_enable_params+'"');var k="";_.has(a,"toggle_enable_params_reverse")&&!0===a.toggle_enable_params_reverse&&(k='data-enable-params-reverse="1"');var p="";_.has(a,"toggle_enabled_by")&&""!==a.toggle_enabled_by&&(p='data-enabled-by="'+a.toggle_enabled_by+'"');var x=' data-responsive="" ',r=tdcSidebarPanel._getParameterCurrentValue(a,c);try{var w=JSON.parse(window.atob(r));x=' data-responsive="'+r+'" ';r="undefined"===typeof w[tdcSidebar.currentViewportSettings.name]?"":w[tdcSidebar.currentViewportSettings.name]}catch(v){}b=
'<div class="tdc-property-responsive '+tdcSidebarPanel._getParameterClasses(a)+'" '+b+" "+e+" "+m+" "+k+" "+p+">";b+='<div class="tdc-property-title"><span class="tdc-search-data"'+d+">"+a.heading+"</span></div>";b=b+'<div class="tdc-property"><input '+(tdcSidebarPanel._getParamterDataAtts(a,c)+' name="'+tdcSidebarPanel._getParameterDomName(a)+'" type="range" data-value="'+r+'" data-min="'+g+'" data-max="'+f+'" data-step="'+l+'" min="'+g+'" max="'+f+'" step="'+l+'" value="'+r+'" '+x+" />");b=b+('<input type="text" class="tdc_range_value" data-default_value="'+
n+'" '+h+' value="'+r+'"/></div><span class="tdc-param-name">')+(a.param_name+"</span>");return b+="</div>"},addRangeMultiple:function(a,c){var b="",e="";_.has(a,"info_img")&&""!==a.info_img&&(b='data-info-img="'+a.info_img+'"');var d="";_.has(a,"description")&&""!==a.description&&(""!==b?e='data-info-descr="'+a.description+'"':d=' title="'+a.description+'" ');var f="";_.has(a,"toggle_enable_params")&&""!==a.toggle_enable_params&&(f='data-enable-params="'+a.toggle_enable_params+'"');var g="";_.has(a,
"toggle_enable_params_reverse")&&!0===a.toggle_enable_params_reverse&&(g='data-enable-params-reverse="1"');var l="";_.has(a,"toggle_enabled_by")&&""!==a.toggle_enabled_by&&(l='data-enabled-by="'+a.toggle_enabled_by+'"');var n=a.tdc_values,h=tdcSidebarPanel._getParameterCurrentValue(a,c),m="",k="",p=[],x="",r="",w="",v="",y="",B="",z="",t;for(t in n)n.hasOwnProperty(t)&&(p.push(n[t].unit),""===r||""===x)&&(v=n[t].unit,r=' data-range_unit="'+v+'" ',w=n[t].value,x=' data-range_value="'+w+'" ',y=n[t].range_min,
B=n[t].range_max,z=n[t].range_step);if(""!==h){for(var u=[],A=0;A<p.length&&!(u=h.split(p[A]),1<u.length);A++);u.length&&(v=p[A],r=' data-range_unit="'+v+'" ',w=u[0],x=' data-range_value="'+w+'" ')}for(t in n)n.hasOwnProperty(t)&&(h=_.uniqueId(),m+=" data-value_"+t+'="'+n[t].value+'" ',m+=" data-min_"+t+'="'+n[t].range_min+'" ',m+=" data-max_"+t+'="'+n[t].range_max+'" ',m+=" data-step_"+t+'="'+n[t].range_step+'" ',p=n[t].value,u="",n[t].unit===v&&(p=w,y=n[t].range_min,B=n[t].range_max,z=n[t].range_step,
u="checked"),k+='<input name="'+tdcSidebarPanel._getParameterDomName(a)+'_unit" data-unit="'+t+'" data-unit_value="'+n[t].unit+'" type="radio" id="'+h+'" '+u+' data-default_value="'+n[t].value+'" data-last_value="'+p+'"/>',k+='<label for="'+h+'">'+n[t].unit+"</label>");b='<div class="'+tdcSidebarPanel._getParameterClasses(a)+'" '+b+" "+e+" "+f+" "+g+" "+l+">";b+='<div class="tdc-property-title"><span class="tdc-search-data"'+d+">"+a.heading+"</span></div>";b=b+'<div class="tdc-property"><input class="tdc-multiple-range" '+
(tdcSidebarPanel._getParamterDataAtts(a,c)+' name="'+tdcSidebarPanel._getParameterDomName(a)+'" type="range" '+x+" "+r+" "+m+' min="'+y+'" max="'+B+'" step="'+z+'" value="'+w+'"/>');b=b+'<div class="tdc-multiple-range-wrap"><div class="tdc-multiple-range-value">'+k+'</div><input type="text" class="tdc_range_value" value="'+(w+'"/>');b+="</div>";b+="</div>";b+='<span class="tdc-param-name">'+a.param_name+"</span>";return b+="</div>"},addRangeMultipleResponsive:function(a,c){var b="",e="";_.has(a,"info_img")&&
""!==a.info_img&&(b='data-info-img="'+a.info_img+'"');var d="";_.has(a,"description")&&""!==a.description&&(""!==b?e='data-info-descr="'+a.description+'"':d=' title="'+a.description+'" ');var f="";_.has(a,"toggle_enable_params")&&""!==a.toggle_enable_params&&(f='data-enable-params="'+a.toggle_enable_params+'"');var g="";_.has(a,"toggle_enable_params_reverse")&&!0===a.toggle_enable_params_reverse&&(g='data-enable-params-reverse="1"');var l="";_.has(a,"toggle_enabled_by")&&""!==a.toggle_enabled_by&&
(l='data-enabled-by="'+a.toggle_enabled_by+'"');var n=a.tdc_values,h=tdcSidebarPanel._getParameterCurrentValue(a,c),k="",q="",p=[],x=' data-responsive="" ',r="",w="",v="",y="",B="",z="",t="",u;for(u in n)n.hasOwnProperty(u)&&(p.push(n[u].unit),""===w||""===r)&&(y=n[u].unit,w=' data-range_unit="'+y+'" ',v=n[u].value,r=' data-range_value="'+v+'" ',B=n[u].range_min,z=n[u].range_max,t=n[u].range_step);if(""!==h){var A=h;try{var C=JSON.parse(window.atob(h));x=' data-responsive="'+h+'" ';A="undefined"===
typeof C[tdcSidebar.currentViewportSettings.name]?"":C[tdcSidebar.currentViewportSettings.name]}catch(D){}if(""!==A){h=[];for(C=0;C<p.length&&!(h=A.split(p[C]),1<h.length);C++);h.length&&(y=p[C],w=' data-range_unit="'+y+'" ',v=h[0],r=' data-range_value="'+v+'" ')}}for(u in n)n.hasOwnProperty(u)&&(p=_.uniqueId(),k+=" data-value_"+u+'="'+n[u].value+'" ',k+=" data-min_"+u+'="'+n[u].range_min+'" ',k+=" data-max_"+u+'="'+n[u].range_max+'" ',k+=" data-step_"+u+'="'+n[u].range_step+'" ',A=n[u].value,h="",
n[u].unit===y&&(A=v,B=n[u].range_min,z=n[u].range_max,t=n[u].range_step,h="checked"),q+='<input name="'+tdcSidebarPanel._getParameterDomName(a)+'_unit" data-unit="'+u+'" data-unit_value="'+n[u].unit+'" type="radio" id="'+p+'" '+h+' data-default_value="'+n[u].value+'" data-last_value="'+A+'"/>',q+='<label for="'+p+'">'+n[u].unit+"</label>");b='<div class="tdc-property-responsive '+tdcSidebarPanel._getParameterClasses(a)+'" '+b+" "+e+" "+f+" "+g+" "+l+">";b+='<div class="tdc-property-title"><span class="tdc-search-data"'+
d+">"+a.heading+"</span></div>";b=b+'<div class="tdc-property"><input class="tdc-multiple-range" '+(tdcSidebarPanel._getParamterDataAtts(a,c)+' name="'+tdcSidebarPanel._getParameterDomName(a)+'" type="range" '+r+" "+w+" "+k+" "+x+' min="'+B+'" max="'+z+'" step="'+t+'" value="'+v+'"/>');b=b+'<div class="tdc-multiple-range-wrap"><div class="tdc-multiple-range-value">'+q+'</div><input type="text" class="tdc_range_value" value="'+(v+'"/>');b+="</div>";b+="</div>";b+='<span class="tdc-param-name">'+a.param_name+
