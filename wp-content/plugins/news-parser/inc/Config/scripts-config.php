...
return  array(
    'global'=>array(),
    'shared'=> array(
        NEWS_PARSER_PLUGIN_SLUG . '-24-chunk'=>array(
            'path'=>NEWS_PARSER_PLUGIN_URL . '/public/js/24-'.NEWS_PARSER_PLUGIN_VERSION.'.bundle.js',
            'depends_on'=>array()
        ),
        NEWS_PARSER_PLUGIN_SLUG . '-594-chunk'=>array(
            'path'=>NEWS_PARSER_PLUGIN_URL . '/public/js/594-'.NEWS_PARSER_PLUGIN_VERSION.'.bundle.js',
            'depends_on'=>array()
        ),
